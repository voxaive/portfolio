      ...
      <div className='contain-about-Sections'>
        <section className='about-me'>
          <div className='box-Skills'>
            ...
            <div className='box-about-me-skills'>
              <Tech_stack tech={"figma"} url={figma} />
              <Tech_stack tech={"figma"} url={figma} />
              <Tech_stack tech={"figma"} url={figma} />
              <Tech_stack tech={"figma"} url={figma} />
              <Tech_stack tech={"figma"} url={figma} />
        ...
        <section className='my-studies'>
          <div className='box-about-me study'>
            <h2>SOBRE <span>MI</span></h2>
            <p>Asistí a un secundario técnico, donde en cuarto año comencé la orientación en computación. Allí pasé por temas como Arduino con C++, Python, Java, diagramaciones, APIs REST con Node.js, HTML, CSS, PHP, MySQL, JavaScript, y fue una experiencia espectacular. </p>
            <p>Me enamoré del hecho de programar y de resolver problemas. En sexto año, comenzamos materias como Desarrollo de Sistemas, donde desarrollamos una app web para gestionar torneos de eSports, y también en Prácticas Profesionalizantes, donde creamos una visual novel, entre otros proyectos que requerían documentar endpoints, realizar diagramas entidad-relación, diagramas de flujo, aplicar metodologías como Scrum, entre otros conocimientos que considero muy valiosos, sobre todo por haber tenido docentes realmente comprometidos.</p>
          </div>
          <div className="circles-wrapper">
            <div className="central">
              <Circle_gigant 
                Study="ET 32 DE 14 - GENERAL JOSE DE SAN MARTIN" 
                url={circleGigant} 
                date="Febrero 2025 - Enero 2025" 
              />
            </div>

            <div className="circle-small circle-1">
              <Cicle_t tech={Et32} url={circle} />
            </div>
